...
let game = {
    ...
    render() {
        ...
        this.ctx.drawImage(this.sprites.ball, this.ball.frame * this.ball.width, 0, this.ball.width, this.ball.height, this.ball.x, this.ball.y, 100, 100);
        this.ctx.drawImage(this.sprites.platform, this.platform.x, this.platform.y, 200, 250);
        this.renderBlocks();
    ...
    renderBlocks() {
        for (let block of this.blocks) {
            if (block.active) {
                this.ctx.drawImage(this.sprites.block, block.x, block.y, 200, 300);
            }
        }
    },
    start: function() {
